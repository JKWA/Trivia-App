...
class TriviaItem {
  ...
  TriviaItem({String category, String question, String correctAnswer, List incorrectAnswers}){
    this.question = _unescape(question);
    this.correctAnswer = new Answer(label: _unescape(correctAnswer), value:true);
